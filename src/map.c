 ...
 * in the tree, and then the support library function #_map_low_insert_color
 * must be called.
 *
 * @param node      The node you want to insert
 * @param parent    The position you want to insert
 * @param rb_link   Will be set to `node`
 * @see _map_low_insert_color
 */
static void _map_low_link_node(ev_map_low_node_t* node,
 ...
 */
static void _map_low_insert_color(ev_map_low_node_t* node, ev_map_low_t* root)
{
 ...
 * @param node      The node
 */
static void ev_map_low_erase(ev_map_low_t* root, ev_map_low_node_t* node)
{
 ...
 * @return          An iterator
 */
static ev_map_low_node_t* _map_low_first(const ev_map_low_t* root)
{
 ...
 * @return          An iterator
 */
static ev_map_low_node_t* _map_low_last(const ev_map_low_t* root)
{
    ev_map_low_node_t* n = root->rb_root;
 ...
 */
static ev_map_low_node_t* _map_low_next(const ev_map_low_node_t* node)
{
 ...
 */
static ev_map_low_node_t* ev_map_low_prev(const ev_map_low_node_t* node)
{
    ev_map_low_node_t* parent;
...
int ev_map_insert(ev_map_t* handler, ev_map_node_t* node)
{
    ...
    handler->size++;
    _map_low_link_node(node, parent, new_node);
    _map_low_insert_color(node, &handler->map_low);
...
{
    return _map_low_first(&handler->map_low);
}

ev_map_node_t* ev_map_end(const ev_map_t* handler)
{
    return _map_low_last(&handler->map_low);
}

ev_map_node_t* ev_map_next(const ev_map_node_t* node)
{
    return _map_low_next(node);
}
